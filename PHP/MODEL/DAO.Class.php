...
public static function clearBdd() {
    $pdo = DbConnect::getDb();
    $database = Gen__Parameters::getNomBdd();
	$sql = "SELECT table_name FROM information_schema.tables WHERE table_schema = '$database' AND table_name LIKE 'gen__%'";
	// var_dump($sql);
...
// public static function deleteDynanic(string $table, array $conditions, bool $debug = false, bool $noObj = false)
// {
//     $db = DbConnect::getDb();
