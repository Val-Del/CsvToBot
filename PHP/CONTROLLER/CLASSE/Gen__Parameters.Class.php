<?php class Gen__Parameters
{
    ...
    {
        self::$_idParameter = $_id_parameter;
    }

    /**
     * Get the value of _file_excel
     */ 
    public function getFile_excel()
    {
        return self::$_file_excel;
    }

    /**
     * Set the value of _file_excel
     *
     * @return  self
     */ 
    public function setFile_excel($_file_excel)
    {
        self::$_file_excel = $_file_excel;
    }
}